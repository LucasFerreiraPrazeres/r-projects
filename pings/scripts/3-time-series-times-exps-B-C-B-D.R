# série temporal das médias dos atrasos de cada experimento B-C e B-D
...
# atrasos dos hosts
times_c <- read.csv("../hosts/B/data/times-C.txt", header=FALSE)
times_d <- read.csv("../hosts/B/data/times-D.txt", header=FALSE)
